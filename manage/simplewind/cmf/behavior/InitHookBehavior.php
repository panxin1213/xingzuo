...
class InitHookBehavior
{
    ...
    public function run($param)
    {
        ...
        //         'Access-Control-Allow-Headers' => 'Authorization,Content-Type,If-Match,If-Modified-Since,If-None-Match,If-Unmodified-Since,X-Requested-With,XX-Device-Type,XX-Token,XX-Api-Version,XX-Wxapp-AppId,X-Requested-With,Content-Type,Access-Control-Allow-Origin,Sec-Fetch-Mode',
        //     ];
